...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuyBrowseV1.CategoryDistribution();
  });
  ...
  describe('CategoryDistribution', function() {
    it('should create an instance of CategoryDistribution', function() {
      // uncomment below and update the code to test CategoryDistribution
      //var instance = new BuyBrowseV1.CategoryDistribution();
      //expect(instance).to.be.a(BuyBrowseV1.CategoryDistribution);
    });
