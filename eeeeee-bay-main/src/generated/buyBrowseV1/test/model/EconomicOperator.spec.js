...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuyBrowseV1.EconomicOperator();
  });
  ...
  describe('EconomicOperator', function() {
    it('should create an instance of EconomicOperator', function() {
      // uncomment below and update the code to test EconomicOperator
      //var instance = new BuyBrowseV1.EconomicOperator();
      //expect(instance).to.be.a(BuyBrowseV1.EconomicOperator);
    });
