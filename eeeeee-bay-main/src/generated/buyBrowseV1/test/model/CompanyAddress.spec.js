...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuyBrowseV1.CompanyAddress();
  });
  ...
  describe('CompanyAddress', function() {
    it('should create an instance of CompanyAddress', function() {
      // uncomment below and update the code to test CompanyAddress
      //var instance = new BuyBrowseV1.CompanyAddress();
      //expect(instance).to.be.a(BuyBrowseV1.CompanyAddress);
    });
