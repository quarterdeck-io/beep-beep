...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuyBrowseV1.AddonService();
  });
  ...
  describe('AddonService', function() {
    it('should create an instance of AddonService', function() {
      // uncomment below and update the code to test AddonService
      //var instance = new BuyBrowseV1.AddonService();
      //expect(instance).to.be.a(BuyBrowseV1.AddonService);
    });
