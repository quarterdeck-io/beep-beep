...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuyBrowseV1.ItemLocationImpl();
  });
  ...
  describe('ItemLocationImpl', function() {
    it('should create an instance of ItemLocationImpl', function() {
      // uncomment below and update the code to test ItemLocationImpl
      //var instance = new BuyBrowseV1.ItemLocationImpl();
      //expect(instance).to.be.a(BuyBrowseV1.ItemLocationImpl);
    });
