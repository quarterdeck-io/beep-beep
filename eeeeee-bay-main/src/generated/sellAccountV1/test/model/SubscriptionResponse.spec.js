...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellAccountV1.SubscriptionResponse();
  });
  ...
  describe('SubscriptionResponse', function() {
    it('should create an instance of SubscriptionResponse', function() {
      ...
      //var instance = new SellAccountV1.SubscriptionResponse();
      //expect(instance).to.be.a(SellAccountV1.SubscriptionResponse);
    });
