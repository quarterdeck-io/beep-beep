...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellAccountV1.SetFulfillmentPolicyResponse();
  });
  ...
  describe('SetFulfillmentPolicyResponse', function() {
    it('should create an instance of SetFulfillmentPolicyResponse', function() {
      ...
      //var instance = new SellAccountV1.SetFulfillmentPolicyResponse();
      //expect(instance).to.be.a(SellAccountV1.SetFulfillmentPolicyResponse);
    });
