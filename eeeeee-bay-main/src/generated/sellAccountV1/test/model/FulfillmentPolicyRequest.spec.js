...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellAccountV1.FulfillmentPolicyRequest();
  });
  ...
  describe('FulfillmentPolicyRequest', function() {
    it('should create an instance of FulfillmentPolicyRequest', function() {
      // uncomment below and update the code to test FulfillmentPolicyRequest
      //var instance = new SellAccountV1.FulfillmentPolicyRequest();
      //expect(instance).to.be.a(SellAccountV1.FulfillmentPolicyRequest);
    });
