...
/**
 * The InventoryItemWithSkuLocaleGroupKeys model module.
 * @module model/InventoryItemWithSkuLocaleGroupKeys
 * @version 1.18.4
 */
class InventoryItemWithSkuLocaleGroupKeys {
    /**
     * Constructs a new <code>InventoryItemWithSkuLocaleGroupKeys</code>.
     * This type is used to provide details about each retrieved inventory item record.
     * @alias module:model/InventoryItemWithSkuLocaleGroupKeys
     */
    constructor() { 
        
        InventoryItemWithSkuLocaleGroupKeys.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InventoryItemWithSkuLocaleGroupKeys</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InventoryItemWithSkuLocaleGroupKeys} obj Optional instance to populate.
     * @return {module:model/InventoryItemWithSkuLocaleGroupKeys} The populated <code>InventoryItemWithSkuLocaleGroupKeys</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InventoryItemWithSkuLocaleGroupKeys();
    ...
    /**
     * Validates the JSON data with respect to <code>InventoryItemWithSkuLocaleGroupKeys</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InventoryItemWithSkuLocaleGroupKeys</code>.
     */
 ...
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['availability'] = undefined;
 ...
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['condition'] = undefined;
 ...
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['conditionDescription'] = undefined;
 ...
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['conditionDescriptors'] = undefined;
 ...
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['inventoryItemGroupKeys'] = undefined;
 ...
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['locale'] = undefined;

/**
 * @member {module:model/PackageWeightAndSize} packageWeightAndSize
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['packageWeightAndSize'] = undefined;

/**
 * @member {module:model/Product} product
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['product'] = undefined;
 ...
 * @member {String} sku
 */
InventoryItemWithSkuLocaleGroupKeys.prototype['sku'] = undefined;
...
export default InventoryItemWithSkuLocaleGroupKeys;
