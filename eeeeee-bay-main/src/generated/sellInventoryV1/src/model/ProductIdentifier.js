 ...
 * @module model/ProductIdentifier
 * @version 1.18.4
 */
class ProductIdentifier {
     ...
     * @alias module:model/ProductIdentifier
     */
    constructor() { 
        
        ProductIdentifier.initialize(this);
    }
     ...
     * @param {module:model/ProductIdentifier} obj Optional instance to populate.
     * @return {module:model/ProductIdentifier} The populated <code>ProductIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ktype')) {
                obj['ktype'] = ApiClient.convertToType(data['ktype'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProductIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductIdentifier</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ktype'] && !(typeof data['ktype'] === 'string' || data['ktype'] instanceof String)) {
            throw new Error("Expected the field `ktype` to be a primitive type in the JSON string but got " + data['ktype']);
        }
 ...
 * @member {String} epid
 */
ProductIdentifier.prototype['epid'] = undefined;
 ...
 * @member {String} gtin
 */
ProductIdentifier.prototype['gtin'] = undefined;
 ...
 * @member {String} ktype
 */
ProductIdentifier.prototype['ktype'] = undefined;
