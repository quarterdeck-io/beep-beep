...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellInventoryV1.ProductFamilyProperties();
  });
  ...
  describe('ProductFamilyProperties', function() {
    it('should create an instance of ProductFamilyProperties', function() {
      // uncomment below and update the code to test ProductFamilyProperties
      //var instance = new SellInventoryV1.ProductFamilyProperties();
      //expect(instance).to.be.a(SellInventoryV1.ProductFamilyProperties);
    });
