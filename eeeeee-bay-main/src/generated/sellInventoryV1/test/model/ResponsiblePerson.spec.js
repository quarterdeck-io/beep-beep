...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellInventoryV1.ResponsiblePerson();
  });
  ...
  describe('ResponsiblePerson', function() {
    it('should create an instance of ResponsiblePerson', function() {
      // uncomment below and update the code to test ResponsiblePerson
      //var instance = new SellInventoryV1.ResponsiblePerson();
      //expect(instance).to.be.a(SellInventoryV1.ResponsiblePerson);
    });
    ...
    it('should have the property contactUrl (base name: "contactUrl")', function() {
