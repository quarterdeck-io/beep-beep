...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellInventoryV1.LocationResponse();
  });
  ...
  describe('LocationResponse', function() {
    it('should create an instance of LocationResponse', function() {
      ...
      //var instance = new SellInventoryV1.LocationResponse();
      //expect(instance).to.be.a(SellInventoryV1.LocationResponse);
    });
