  ...
  useEffect(() => {
    ...
    if (success === "true") {
      ...
      const errorMessages: Record<string, string> = {
        ...
        missing_scopes: "Required eBay scopes are missing. Please ensure EBAY_SCOPE includes 'sell.inventory' and 'sell.inventory.readonly' in your .env.local file, then restart your dev server.",
